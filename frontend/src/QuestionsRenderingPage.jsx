...
//                 <div
//                   key={i}
//                   className={`bg-white border transition-all duration-200 p-6 rounded-3xl shadow-sm hover:shadow-md ${
...
//         {/* Chatbot Sidebar */}
//         <div
//           className={`fixed top-0 right-0 h-full w-full lg:w-[400px] bg-white shadow-2xl transform transition-all duration-300 z-50 flex flex-col ${
